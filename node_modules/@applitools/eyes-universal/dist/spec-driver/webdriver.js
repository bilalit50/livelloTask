...
function transformDriver(driver) {
    ...
    if (driver.proxyUrl || ((_a = driver.proxy) === null || _a === void 0 ? void 0 : _a.url)) {
        const proxy = { ...(0, url_1.parse)((_b = driver.proxyUrl) !== null && _b !== void 0 ? _b : driver.proxy.url), rejectUnauthorized: false };
        const agent = new proxy_agent_1.default(proxy);
...
async function getBarsSize(browser) {
