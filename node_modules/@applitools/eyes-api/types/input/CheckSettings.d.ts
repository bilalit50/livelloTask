...
declare type PaddedRegionReference<TElement, TSelector> = {
    region: RegionReference<TElement, TSelector>;
...
export declare class CheckSettingsFluent<TElement = unknown, TSelector = unknown> {
    ...
    ignoreRegion(region: RegionReference<TElement, TSelector> | PaddedRegionReference<TElement, TSelector> | LegacyRegion): this;
    ignoreRegions(...regions: (RegionReference<TElement, TSelector> | PaddedRegionReference<TElement, TSelector> | LegacyRegion)[]): this;
    /** @deprecated */
    ...
    layoutRegion(region: RegionReference<TElement, TSelector> | PaddedRegionReference<TElement, TSelector> | LegacyRegion): this;
    layoutRegions(...regions: (RegionReference<TElement, TSelector> | PaddedRegionReference<TElement, TSelector> | LegacyRegion)[]): this;
    strictRegion(region: RegionReference<TElement, TSelector> | PaddedRegionReference<TElement, TSelector> | LegacyRegion): this;
    strictRegions(...regions: (RegionReference<TElement, TSelector> | PaddedRegionReference<TElement, TSelector> | LegacyRegion)[]): this;
    contentRegion(region: RegionReference<TElement, TSelector> | PaddedRegionReference<TElement, TSelector> | LegacyRegion): this;
    contentRegions(...regions: (RegionReference<TElement, TSelector> | PaddedRegionReference<TElement, TSelector> | LegacyRegion)[]): this;
